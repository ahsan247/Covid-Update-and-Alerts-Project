...
<body>
    <nav class="navbar navbar-light navbar-expand-md fixed-top navigation-clean-button" style="background: var(--white);box-shadow: 0px 0px 2px;border-bottom-width: 0px;border-bottom-color: var(--secondary);">
        <div class="container"><a class="navbar-brand" href="index.php"><img src="https://i.ibb.co/hmFmhCg/logo.png" alt="logo" border="0"></a><button class="navbar-toggler" data-toggle="collapse" style="background: var(--white);border-style: none;border-color: var(--light);"><span class="sr-only">Toggle navigation</span><span class="navbar-toggler-icon" style="border-color: var(--white);"></span></button></div>
    </nav>
    <section class="login-clean" style="background-color: transparent;font-family: Poppins, sans-serif;">
        <form method="post" action="admin_signin.php" style="margin-top: -16px;" >
            <h2 class="sr-only">Login Form</h2>
            <div class="illustration"><i class="icon ion-ios-navigate" style="color: var(--red);margin-top: 0px;margin-bottom: 0px;"></i></div><a class="forgot" href="register.html" style="margin-top: -40px;margin-bottom: 45px;font-family: Montserrat, sans-serif;font-size: 25px;font-weight: bold;color: var(--red);">Admin Login</a>
