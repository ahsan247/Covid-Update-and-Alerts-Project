...
<body style="margin: auto;margin-top: 0px;">
    ...
    <div class="row register-form">
        <div class="col-md-8 offset-md-2">
            ...
            <form method="POST" action="uploadinfo.php" enctype="multipart/form-data">

                <form class="form-row form-group">
                    <h1>Update Information</h1>

                    <div class="form-row form-group">
                        <div class="col-sm-4 label-column"><label class="col-form-label" for="number-input-field">Death</label></div>
                        <div class="col-sm-6 input-column"><input class="form-control" type="number" name="death" id="death" required /></div>
                    </div>
                    <div class="form-row form-group">
                        <div class="col-sm-4 label-column"><label class="col-form-label" for="number-input-field">Recovery</label></div>
                        <div class="col-sm-6 input-column"><input class="form-control" type="number" name="recovery" id="recovery" required /></div>
                    </div>
                    <div class="form-row form-group">
                        <div class="col-sm-4 label-column"><label class="col-form-label" for="number-input-field">Active Cases</label></div>
                        <div class="col-sm-6 input-column"><input class="form-control" type="number" name="active" id="active" required /></div>
                    </div>
