    ...
    <nav class="navbar navbar-light navbar-expand-md fixed-top navigation-clean-button" style="background: var(--white);box-shadow: 0px 0px 2px;border-bottom-width: 0px;border-bottom-color: var(--secondary);">
        <div class="container"><a class="navbar-brand" href="index.php"><img src="https://i.ibb.co/hmFmhCg/logo.png" alt="logo" border="0"></a><button data-toggle="collapse" class="navbar-toggler" data-target="#navcol-1" style="background: var(--white);border-style: none;border-color: var(--light);"><span class="sr-only">Toggle navigation</span><span class="navbar-toggler-icon" style="border-color: var(--white);"></span></button>
            <div class="collapse navbar-collapse" id="navcol-1">
                ...
                </ul><span class="navbar-text actions"> <a class="btn btn-light text-center action-button" role="button" href="signup.php" style="border-color: var(--blue);background: linear-gradient(rgb(213,37,37) 0%, rgb(213,37,37) 100%);font-family: Montserrat, sans-serif;"><strong>Sign Up</strong></a></span>
            </div>
        </div>
    </nav>
    <section class="login-clean" style="background-color: transparent;font-family: Poppins, sans-serif;">
        <form method="post" style="margin-top: 15px;" action="user_signin.php">
            <h2 class="sr-only">Login Form</h2>
            <div class="illustration"><i class="icon ion-ios-navigate" style="color: var(--red);"></i></div><a class="forgot" href="register.html" style="font-family: Montserrat, sans-serif;font-weight: bold;font-size: 30px;margin-bottom: 30px;margin-top: -40px;color: var(--red);">User Login</a>
            <div class="form-group"><input type="tel" class="form-control" name="mobile" placeholder="Mobile Number" /></div>
            <div class="form-group"><input type="password" class="form-control" name="password" placeholder="Password" /></div>
            <div class="form-group"><button class="btn btn-primary btn-block" type="submit" style="background: var(--red);">Login</button></div>
        </form>
    </section>
